                              ...
                              StreamBuilder<List<ListingRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return FlutterFlowCheckboxGroup(
                                    ...
                                    controller:
                                        _model.regionCheckboxGroupController ??=
                    ...
                    child: StreamBuilder<List<ListingRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        return FlutterFlowDropDown<String>(
                          controller: _model.listingTypeDropdownController ??=
                          ...
                          options: functions
                              .uniqueStr(listingTypeDropdownListingRecordList
                                  .map((e) => e.listingType)
                                  .withoutNulls
                                  .toList())
                              .toList(),
                              ...
                              child: Container(
                                ...
                                child: Slider(
                                  ...
                                  value: _model.maxPriceSliderValue ??=
                                      2000000.0,
                                  label: _model.maxPriceSliderValue.toString(),
                                  divisions: 150,
                                  onChanged: (newValue) {
                                    newValue = double.parse(
                                        newValue.toStringAsFixed(0));
                                    setState(() =>
                                        _model.maxPriceSliderValue = newValue);
                                  },
                                ),
                              ),
                            ),
                      ...
                      child: StreamBuilder<List<ListingRecord>>(
                        stream: queryListingRecord(
                          queryBuilder: (listingRecord) => listingRecord
                              .where('listingType',
                                  isEqualTo: _model.listingTypeDropdownValue)
                              .whereIn(
                                  'region', _model.regionCheckboxGroupValues)
                              .where('propertyPrice',
                                  isLessThanOrEqualTo:
                                      _model.maxPriceSliderValue),
                        ),
                        builder: (context, snapshot) {
                          // Customize what your widget looks like when it's loading.
                          if (!snapshot.hasData) {
                          ...
                          List<ListingRecord>
                              filterListingButtonListingRecordList =
                              snapshot.data!;
                          return FFButtonWidget(
                            onPressed: () async {
                              if (_model.regionSelected) {
                                if (filterListingButtonListingRecordList
                                        .length !=
                                    0) {
                                  ...
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        ...
                                        content: Text(
                                            'Please expand your filter range or waiting for new listings to be added! Sorry for the inconvenience!'),
                                        actions: [
                                          TextButton(
