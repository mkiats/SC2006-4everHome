...
export 'k2_id_app_project_model.dart';

class K2IdAppProjectWidget extends StatefulWidget {
  const K2IdAppProjectWidget({Key? key}) : super(key: key);

  @override
  _K2IdAppProjectWidgetState createState() => _K2IdAppProjectWidgetState();
}

class _K2IdAppProjectWidgetState extends State<K2IdAppProjectWidget>
    with TickerProviderStateMixin {
  late K2IdAppProjectModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => K2IdAppProjectModel());
                    ...
                    children: [
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              'Choose your preferred interior designer',
                      ...
                      SingleChildScrollView(
                        child: Column(
                          mainAxisSize: MainAxisSize.max,
                          children: [
                            if (_model.idFullList)
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 50.0, 0.0, 0.0),
                                child:
                                    StreamBuilder<List<InteriorDesignerRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<InteriorDesignerRecord>
                                        iDListInteriorDesignerRecordList =
                                        snapshot.data!;
                                    return ListView.builder(
                                      ...
                                      itemCount:
                                          iDListInteriorDesignerRecordList
                                              .length,
                                      itemBuilder: (context, iDListIndex) {
                                        final iDListInteriorDesignerRecord =
                                            iDListInteriorDesignerRecordList[
                                                iDListIndex];
                                        return Padding(
                                          padding:
                                            ...
                                            onTap: () async {
                                              await showModalBottomSheet(
                                                ...
                                                builder: (context) {
                                                  ...
                                                  _model.interiorDesignerSelectedID =
                                                      value));
                                              ...
                                              if (!FFAppState()
                                                  ...
                                                  (iDListInteriorDesignerRecord
                                                          .loginId ==
                                                      _model
                                                          .interiorDesignerSelectedID!
                                                          .loginId)) {
                                                _model.selectedIDAgent = _model
                                                    .interiorDesignerSelectedID!
                                                    .loginId;
                                              }
                                ...
                                child: Builder(
                                  builder: (context) {
                                    ...
                                    return ListView.builder(
                                      ...
                                      shrinkWrap: true,
                                      scrollDirection: Axis.vertical,
                                      itemCount: searchedIDList.length,
                                      itemBuilder:
                                          (context, searchedIDListIndex) {
                                        final searchedIDListItem =
                                            searchedIDList[searchedIDListIndex];
                                        return Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  16.0, 8.0, 16.0, 0.0),
                          ...
                          return FFButtonWidget(
                            onPressed: () async {
                              final listingApplicationUpdateData =
                                ...
                                interiorDesignerID: _model.selectedIDAgent,
                              );
                              ...
                              await Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => LSummaryProjectWidget(),
                                ),
                              );
                            },
                            text: 'Confirm ID',
