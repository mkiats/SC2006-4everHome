...
class H32LoanEstimateProjectWidget extends StatefulWidget {
  const H32LoanEstimateProjectWidget({
    Key? key,
  ...
  @override
  _H32LoanEstimateProjectWidgetState createState() =>
      _H32LoanEstimateProjectWidgetState();
}

class _H32LoanEstimateProjectWidgetState
    extends State<H32LoanEstimateProjectWidget> {
  late H32LoanEstimateProjectModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => H32LoanEstimateProjectModel());
  }
