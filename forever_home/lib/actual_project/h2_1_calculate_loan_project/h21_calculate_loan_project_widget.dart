...
import 'h21_calculate_loan_project_model.dart';
export 'h21_calculate_loan_project_model.dart';

class H21CalculateLoanProjectWidget extends StatefulWidget {
  const H21CalculateLoanProjectWidget({
    Key? key,
  ...
  @override
  _H21CalculateLoanProjectWidgetState createState() =>
      _H21CalculateLoanProjectWidgetState();
}

class _H21CalculateLoanProjectWidgetState
    extends State<H21CalculateLoanProjectWidget> {
  late H21CalculateLoanProjectModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => H21CalculateLoanProjectModel());
                              ...
                              onPressed: () async {
                                if ((_model.pageH21UserDownPaymentInputController
                                        ...
                                        _model.pageH21UserDownPaymentInputController
                                                .text !=
                                            '') &&
                                    (_model.pageH21UserInterestInputController.text != null &&
                                        _model.pageH21UserInterestInputController
                                                .text !=
                                            '') &&
                                    (_model.pageH21UserTenureInputController
